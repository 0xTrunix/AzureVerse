...
export const translations: Record<Language, TranslationCopy> = {
  zh: {
    siteName: 'AzureVerse',
    heroSearchPlaceholder: '搜索戒指、项链、蓝钻、白钻...',
  ...
  en: {
    siteName: 'AzureVerse',
    heroSearchPlaceholder: 'Search rings, necklaces, blue diamond...',
    catalogue: 'Collections',
...
export const colorCopy: Record<Color, Record<Language, string>> = {
  蓝色: { zh: '蓝钻', en: 'Blue Diamond' },
  黄色: { zh: '黄钻', en: 'Yellow Diamond' },
  绿色: { zh: '绿钻', en: 'Green Diamond' },
  红色: { zh: '红钻', en: 'Red Diamond' },
  粉色: { zh: '粉钻', en: 'Pink Diamond' },
